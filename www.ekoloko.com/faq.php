...
<script type="text/javascript">
  ...
  __wm.wombat("http://web3.ekoloko.com:80/faq.php","20100123001215","http://web.archive.org/","web","https://web-static.archive.org/_static/",
	      "1264205535");
</script>
...
<script type="text/javascript" src="/web/20100123001215js_/http://web3.ekoloko.com/styles/prosilver/template/styleswitcher.js"></script>
<script type="text/javascript" src="/web/20100123001215js_/http://web3.ekoloko.com/styles/prosilver/template/forum_fn.js"></script>

<link href="/web/20100123001215cs_/http://web3.ekoloko.com/styles/prosilver/theme/print.css" rel="stylesheet" type="text/css" media="print" title="printonly"/>
<link href="/web/20100123001215cs_/http://web3.ekoloko.com/style.php?sid=19d9407ce8849cce4aec9df14df696ad&amp;id=1&amp;lang=en" rel="stylesheet" type="text/css" media="screen, projection"/>

<link href="/web/20100123001215cs_/http://web3.ekoloko.com/styles/prosilver/theme/normal.css" rel="stylesheet" type="text/css" title="A"/>
<link href="/web/20100123001215cs_/http://web3.ekoloko.com/styles/prosilver/theme/medium.css" rel="alternate stylesheet" type="text/css" title="A+"/>
<link href="/web/20100123001215cs_/http://web3.ekoloko.com/styles/prosilver/theme/large.css" rel="alternate stylesheet" type="text/css" title="A++"/>
	...
	<div id="page-header">
		<div class="headerbar">
			...
			<div id="site-description">
				<a href="./index.php" title="Board index" id="logo"><img src="/web/20100123001215im_/http://web3.ekoloko.com/styles/prosilver/imageset/site_logo.gif" width="680" height="123" alt="" title=""/></a>
				<h1></h1>
				<p></p>
...
<div class="clear"></div>
	...
	<div class="panel bg2">
		...
		<div class="content">
			<h2>phpBB 3 Issues</h2>
					...
					<dd>This software (in its unmodified form) is produced, released and is copyright <a href="http://web.archive.org/web/20100123001215/http://www.phpbb.com/">phpBB Group</a>. It is made available under the GNU General Public License and may be freely distributed. See the link for more details.</dd>
					<dd><a href="#faqlinks" class="top2">Top</a></dd>
				</dl>
				<hr class="dashed"/>				<dl class="faq">
				...
				<hr class="dashed"/>				<dl class="faq">
					...
					<dd>Any of the administrators listed on the “The team” page should be an appropriate point of contact for your complaints. If this still gets no response then you should contact the owner of the domain (do a <a href="http://web.archive.org/web/20100123001215/http://www.google.com/search?q=whois">whois lookup</a>) or, if this is running on a free service (e.g. Yahoo!, free.fr, f2s.com, etc.), the management or abuse department of that service. Please note that the phpBB Group has <strong>absolutely no jurisdiction</strong> and cannot in any way be held liable over how, where or by whom this board is used. Do not contact the phpBB Group in relation to any legal (cease and desist, liable, defamatory comment, etc.) matter <strong>not directly related</strong> to the phpBB.com website or the discrete software of phpBB itself. If you do e-mail phpBB Group <strong>about any third party</strong> use of this software then you should expect a terse response or no response at all.</dd>
					<dd><a href="#faqlinks" class="top2">Top</a></dd>
				</dl>
						</div>
	...
	<form method="post" id="jumpbox" action="./viewforum.php" onsubmit="if(document.jumpbox.f.value == -1){return false;}">
			...
			<option value="-1">------------------</option>				<option value="4">הכרזות</option>
							<option value="6">פורום אקולוקו לסיירי 2</option>
							<option value="8">&nbsp; &nbsp;על הפורום</option>
							<option value="7">&nbsp; &nbsp;יש לי בעיה</option>
							<option value="14">&nbsp; &nbsp;בעיות של סיירים</option>
							<option value="15">&nbsp; &nbsp;מה מותר ומה אסור? (כללי ההתנהגות באקולוקו)</option>
							<option value="9">&nbsp; &nbsp;חדשות הסיירים</option>
							<option value="16">&nbsp; &nbsp;דיווחים חשובים</option>
							<option value="10">&nbsp; &nbsp;חדר הדיונים של הסיירת</option>
							<option value="11">&nbsp; &nbsp;יש לי רעיון</option>
							<option value="17">&nbsp; &nbsp;כל הפגישות שבעולם</option>
							<option value="18">&nbsp; &nbsp;הפעלות לסיירים</option>
							<option value="19">&nbsp; &nbsp;סיפורי אקולוקו</option>
							<option value="12">&nbsp; &nbsp;סקר השבוע</option>
							<option value="20">&nbsp; &nbsp;מנהלים אורחים</option>
						</select>
...
//-->
	...
	<div class="copyright">Powered by <a href="http://web.archive.org/web/20100123001215/http://www.phpbb.com/">phpBB</a> &copy; 2000, 2002, 2005, 2007 phpBB Group
			</div>
</div>
...
<div>
	<a id="bottom" name="bottom" accesskey="z"></a>
     ...
     FILE ARCHIVED ON 00:12:15 Jan 23, 2010 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 09:32:03 Oct 10, 2025.
...
playback timings (ms):
  ...
  PetaboxLoader3.datanode: 502.728 (4)
  load_resource: 1550.524
  PetaboxLoader3.resolve: 1174.666
-->