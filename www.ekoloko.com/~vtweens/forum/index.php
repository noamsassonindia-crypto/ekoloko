...
<div id="wrapheader">
	...
	<div id="datebar">
		<table width="100%" cellspacing="0">
		<tr>
			<td class="gensmall">Last visit was: Sat Jan 31, 2009 4:23 am</td>
			<td class="gensmall" align="right">It is currently Sat Jan 31, 2009 4:23 am<br /></td>
		</tr>
		</table>
	</div>
	...
	<th>&nbsp;Last post&nbsp;</th>
		...
		<tr>
			...
			<td class="row2" align="center" nowrap="nowrap">
									<p class="topicdetails">Thu Jan 29, 2009 5:29 am</p>
					<p class="topicdetails">seoceo2008						<a href="./viewtopic.php?f=3&amp;p=328#p328"><img src="./styles/subsilver2/imageset/icon_topic_latest.gif" width="18" height="9" alt="View the latest post" title="View the latest post" /></a>
					</p>
							</td>
		</tr>
	</table>
...
<table class="tablebg" width="100%" cellspacing="1" cellpadding="0" style="margin-top: 5px;">
	...
	<tr>
			...
			<td class="row1" width="100%"><span class="genmed">In total there is <strong>1</strong> user online :: 1 registered, 0 hidden and 0 guests (based on users active over the past 5 minutes)<br />Most users ever online was <strong>4</strong> on Tue Dec 16, 2008 3:35 pm<br /><br />Registered users: <span style="color: #9E8DA7;" class="username-coloured">Alexa [Bot]</span></span></td>
	</tr>
			<tr>
...
<tr>
	...
	<td class="row1" width="100%" valign="middle"><p class="genmed">Total posts <strong>320</strong> | Total topics <strong>1</strong> | Total members <strong>95</strong> | Our newest member <strong>datzmony</strong></p></td>
</tr>
</table>
